...
class KafkaQueueIntegrationTests
    ...
    constructor(
        ...
        @Test
        fun `posts all message variants and processes them`() =
            runSuspending {
        ...
        @Test
        fun `routes malformed bytes to dlt and processes a later valid audit`() =
            runSuspending {
